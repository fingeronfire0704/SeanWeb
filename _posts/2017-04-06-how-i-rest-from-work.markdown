...
Because the scooter is dockless, the customer returns the scooter at a random location within the operation region. As a result, we aims to build a demand prediction model and relocation optimization model.
